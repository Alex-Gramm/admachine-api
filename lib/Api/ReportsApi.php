...
class ReportsApi
{
    ...
    protected function reportsGetRequest($segment, $from, $to, $columns, $filters = null, $timezone_id = null)
    {
        ...
        // query params
        if ($segment !== null) {
            $queryParams['segment'] = ObjectSerializer::toQueryValue($segment);
        }
        // query params
        if ($from !== null) {
        ...
        // query params
        if (is_array($columns)) {
            $columns = ObjectSerializer::serializeCollection($columns, 'csv', true);
        }
        if ($columns !== null) {
        ...
        // query params
        if (is_array($filters)) {
            $filters = ObjectSerializer::serializeCollection($filters, 'csv', true);
        }
        if ($filters !== null) {
        ...
        // query params
        if ($timezone_id !== null) {
            $queryParams['timezone_id'] = ObjectSerializer::toQueryValue($timezone_id);
        }
