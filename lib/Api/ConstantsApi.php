...
class ConstantsApi
{
    ...
    {
        list($response) = $this->constantsGetWithHttpInfo();
        return $response;
    }
    ...
    {
        $request = $this->constantsGetRequest();
    ...
    {
        return $this->constantsGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function constantsGetRequest()
    {
