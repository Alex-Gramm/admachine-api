...
/**
 * EditCampaign Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class EditCampaign implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'editCampaign';
     ...
     * Sets time_zone
     *
     * @param float|null $time_zone Time Zone. One of the ID values of parameter `time_zones` in /constants is added to this parameter.
     *
     * @return $this
     */
     ...
     *
     * @param float|null $is_unlimited_budget Budget Flights. 1 - Unlimited, 0 - Use Flights.
     *
     * @return $this
     */
     ...
     *
     * @param float|null $daily_budget_is_unlimited Daily Spend Cap. 1 - Unlimited, 0 - Use daily_budget.
     *
     * @return $this
     */
    ...
    public function setDailyBudget($daily_budget)
    {
        ...
        if (!is_null($daily_budget) && ($daily_budget < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $daily_budget when calling EditCampaign., must be bigger than or equal to 0.01.');
        }
    ...
    public function setFrequencyCap($frequency_cap)
    {
        ...
        if (!is_null($frequency_cap) && ($frequency_cap < 0)) {
            throw new \InvalidArgumentException('invalid value for $frequency_cap when calling EditCampaign., must be bigger than or equal to 0.');
        }
    ...
    public function setMacrosCustomData($macros_custom_data)
    {
        if (!is_null($macros_custom_data) && (mb_strlen($macros_custom_data) > 500)) {
            throw new \InvalidArgumentException('invalid length for $macros_custom_data when calling EditCampaign., must be smaller than or equal to 500.');
        }
    ...
    public function setPixelEventsRepeatTime($pixel_events_repeat_time)
    {
        ...
        if (!is_null($pixel_events_repeat_time) && ($pixel_events_repeat_time < 1)) {
            throw new \InvalidArgumentException('invalid value for $pixel_events_repeat_time when calling EditCampaign., must be bigger than or equal to 1.');
        }
    ...
    public function setPostClickWindow($post_click_window)
    {
        ...
        if (!is_null($post_click_window) && ($post_click_window < 1)) {
            throw new \InvalidArgumentException('invalid value for $post_click_window when calling EditCampaign., must be bigger than or equal to 1.');
        }
    ...
    public function setPostViewWindow($post_view_window)
    {
        ...
        if (!is_null($post_view_window) && ($post_view_window < 1)) {
            throw new \InvalidArgumentException('invalid value for $post_view_window when calling EditCampaign., must be bigger than or equal to 1.');
        }
