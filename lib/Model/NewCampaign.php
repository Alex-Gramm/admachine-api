...
class NewCampaign implements ModelInterface, ArrayAccess
{
    ...
    public function setDailyBudget($daily_budget)
    {
        ...
        if (!is_null($daily_budget) && ($daily_budget < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $daily_budget when calling NewCampaign., must be bigger than or equal to 0.01.');
        }
    ...
    public function setFrequencyCap($frequency_cap)
    {
        ...
        if (($frequency_cap < 0)) {
            throw new \InvalidArgumentException('invalid value for $frequency_cap when calling NewCampaign., must be bigger than or equal to 0.');
        }
    ...
    public function setPixelEventsRepeatTime($pixel_events_repeat_time)
    {
        ...
        if (!is_null($pixel_events_repeat_time) && ($pixel_events_repeat_time < 1)) {
            throw new \InvalidArgumentException('invalid value for $pixel_events_repeat_time when calling NewCampaign., must be bigger than or equal to 1.');
        }
    ...
    public function setPostClickWindow($post_click_window)
    {
        ...
        if (!is_null($post_click_window) && ($post_click_window < 1)) {
            throw new \InvalidArgumentException('invalid value for $post_click_window when calling NewCampaign., must be bigger than or equal to 1.');
        }
    ...
    public function setPostViewWindow($post_view_window)
    {
        ...
        if (!is_null($post_view_window) && ($post_view_window < 1)) {
            throw new \InvalidArgumentException('invalid value for $post_view_window when calling NewCampaign., must be bigger than or equal to 1.');
        }
