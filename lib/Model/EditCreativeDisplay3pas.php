...
class EditCreativeDisplay3pas implements ModelInterface, ArrayAccess
{
    ...
    public function setDisplayWidth($display_width)
    {
        ...
        if (!is_null($display_width) && ($display_width < 1)) {
            throw new \InvalidArgumentException('invalid value for $display_width when calling EditCreativeDisplay3pas., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayHeight($display_height)
    {
        ...
        if (!is_null($display_height) && ($display_height < 1)) {
            throw new \InvalidArgumentException('invalid value for $display_height when calling EditCreativeDisplay3pas., must be bigger than or equal to 1.');
        }
