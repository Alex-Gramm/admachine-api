 ...
 * @link     https://openapi-generator.tech
 */
class NewStrategy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'newStrategy';
    ...
    protected static $attributeMap = [
        ...
        'custom_xml_params' => 'custom_xml_params',
    ...
    protected static $setters = [
        ...
        'custom_xml_params' => 'setCustomXmlParams',
    ...
    protected static $getters = [
        ...
        'custom_xml_params' => 'getCustomXmlParams',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['custom_xml_params'] = isset($data['custom_xml_params']) ? $data['custom_xml_params'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['use_campaign_start_date'] === null) {
            $invalidProperties[] = "'use_campaign_start_date' can't be null";
        }
        if ($this->container['use_campaign_end_date'] === null) {
            $invalidProperties[] = "'use_campaign_end_date' can't be null";
        }
        ...
        if ($this->container['max_bid'] === null) {
            $invalidProperties[] = "'max_bid' can't be null";
        }
        if (($this->container['max_bid'] > 999999.99)) {
            $invalidProperties[] = "invalid value for 'max_bid', must be smaller than or equal to 999999.99.";
        }

        if (($this->container['max_bid'] < 0.01)) {
            $invalidProperties[] = "invalid value for 'max_bid', must be bigger than or equal to 0.01.";
        }

        if ($this->container['budget_pacing_type'] === null) {
            $invalidProperties[] = "'budget_pacing_type' can't be null";
        }
        ...
        if ($this->container['budget_period'] === null) {
            $invalidProperties[] = "'budget_period' can't be null";
        }
        if ($this->container['impressions_cap_is_unlimited'] === null) {
            $invalidProperties[] = "'impressions_cap_is_unlimited' can't be null";
        }
        ...
        if ($this->container['rtb_supply_type_open_or_private'] === null) {
            $invalidProperties[] = "'rtb_supply_type_open_or_private' can't be null";
        }
        if ($this->container['inventory_types'] === null) {
            $invalidProperties[] = "'inventory_types' can't be null";
        }
        if ($this->container['any_ssp_is_allowed'] === null) {
            $invalidProperties[] = "'any_ssp_is_allowed' can't be null";
        }
        if ($this->container['any_rtb_deal_is_allowed'] === null) {
            $invalidProperties[] = "'any_rtb_deal_is_allowed' can't be null";
        }
        if ($this->container['is_all_days_part'] === null) {
            $invalidProperties[] = "'is_all_days_part' can't be null";
        }
        ...
        if (!is_null($this->container['custom_xml_params']) && (mb_strlen($this->container['custom_xml_params']) > 500)) {
            $invalidProperties[] = "invalid value for 'custom_xml_params', the character length must be smaller than or equal to 500.";
        }
     ...
     * Sets channel
     *
     * @param float $channel One of the ID values of parameter `channels` in /constants is added to this parameter.
     *
     * @return $this
     */
     ...
     *
     * @param float $use_campaign_start_date Use Campaign Start Date - 1, No - 0.
     *
     * @return $this
     */
     ...
     *
     * @param float $use_campaign_end_date Use Campaign End Date - 1, No - 0.
     *
     * @return $this
     */
    ...
    public function setStartTimeInterface($start_time_interface)
    {
        ...
        if (!is_null($start_time_interface) && (!preg_match("/^(([0,1][0-9])|(2[0-3])):[0-5][0-9]$/", $start_time_interface))) {
            throw new \InvalidArgumentException("invalid value for $start_time_interface when calling NewStrategy., must conform to the pattern /^(([0,1][0-9])|(2[0-3])):[0-5][0-9]$/.");
        }
    ...
    public function setEndTimeInterface($end_time_interface)
    {
        ...
        if (!is_null($end_time_interface) && (!preg_match("/^(([0,1][0-9])|(2[0-3])):[0-5][0-9]$/", $end_time_interface))) {
            throw new \InvalidArgumentException("invalid value for $end_time_interface when calling NewStrategy., must conform to the pattern /^(([0,1][0-9])|(2[0-3])):[0-5][0-9]$/.");
        }
     ...
     *
     * @param float $is_unlimited_budget Unlimited Budget.
     *
     * @return $this
     */
    ...
    public function setTotalBudget($total_budget)
    {
        ...
        if (!is_null($total_budget) && ($total_budget > 9999999)) {
            throw new \InvalidArgumentException('invalid value for $total_budget when calling NewStrategy., must be smaller than or equal to 9999999.');
        }
        if (!is_null($total_budget) && ($total_budget < 1)) {
            throw new \InvalidArgumentException('invalid value for $total_budget when calling NewStrategy., must be bigger than or equal to 1.');
        }
     ...
     * Sets max_bid
     *
     * @param float $max_bid Max. CPM bid.
     *
     * @return $this
     */
    public function setMaxBid($max_bid)
    {
        ...
        if (($max_bid > 999999.99)) {
            throw new \InvalidArgumentException('invalid value for $max_bid when calling NewStrategy., must be smaller than or equal to 999999.99.');
        }
        if (($max_bid < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $max_bid when calling NewStrategy., must be bigger than or equal to 0.01.');
        }
     ...
     *
     * @param float $budget_pacing_type Pacing Type. One of the ID values of parameter `budget_pacing_types` in /constants is added to this parameter.
     *
     * @return $this
     */
    ...
    public function setLocalBudget($local_budget)
    {
        ...
        if (!is_null($local_budget) && ($local_budget > 999999.99)) {
            throw new \InvalidArgumentException('invalid value for $local_budget when calling NewStrategy., must be smaller than or equal to 999999.99.');
        }
        if (!is_null($local_budget) && ($local_budget < 25)) {
            throw new \InvalidArgumentException('invalid value for $local_budget when calling NewStrategy., must be bigger than or equal to 25.');
        }
     ...
     * Sets budget_period
     *
     * @param float $budget_period Budget Period. One of the ID values of parameter `budget_pacing_budget_intervals` in /constants is added to this parameter.
     *
     * @return $this
     */
     ...
     *
     * @param float $impressions_cap_is_unlimited Unlimited impressions cap - 0. No - 1.
     *
     * @return $this
     */
    ...
    public function setImpressionsCap($impressions_cap)
    {
        ...
        if (!is_null($impressions_cap) && ($impressions_cap < 1)) {
            throw new \InvalidArgumentException('invalid value for $impressions_cap when calling NewStrategy., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param float $rtb_supply_type_open_or_private Supply Type. One of the ID values of parameter `rtb_supply_types` in /constants is added to this parameter.
     *
     * @return $this
     */
     ...
     *
     * @param string $inventory_types Inventory Types. ID values of parameter `inventory_types` in /constants is added to this parameter. For example 1 or 1,2.
     *
     * @return $this
     */
     ...
     *
     * @param float $any_ssp_is_allowed Run on all Open Supply sources. Run All - 1. Not All - 0.
     *
     * @return $this
     */
     ...
     *
     * @param float $any_rtb_deal_is_allowed Run on all deals. Run All - 1. Not All - 0.
     *
     * @return $this
     */
     ...
     *
     * @param float $is_all_days_part Run on all day parts. Run All - 1. Not All - 0.
     *
     * @return $this
     */
    ...
    public function setMacrosCustomData($macros_custom_data)
    {
        if (!is_null($macros_custom_data) && (mb_strlen($macros_custom_data) > 500)) {
            throw new \InvalidArgumentException('invalid length for $macros_custom_data when calling NewStrategy., must be smaller than or equal to 500.');
        }
    ...
    /**
     * Gets custom_xml_params
     *
     * @return string|null
     */
    public function getCustomXmlParams()
    {
        return $this->container['custom_xml_params'];
    }

    /**
     * Sets custom_xml_params
     *
     * @param string|null $custom_xml_params custom_xml_params
     *
     * @return $this
     */
    public function setCustomXmlParams($custom_xml_params)
    {
        if (!is_null($custom_xml_params) && (mb_strlen($custom_xml_params) > 500)) {
            throw new \InvalidArgumentException('invalid length for $custom_xml_params when calling NewStrategy., must be smaller than or equal to 500.');
        }

        $this->container['custom_xml_params'] = $custom_xml_params;
