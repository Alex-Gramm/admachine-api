...
class Organization implements ModelInterface, ArrayAccess
{
    ...
    public function setMinAllowedBalance($min_allowed_balance)
    {
        ...
        if (!is_null($min_allowed_balance) && ($min_allowed_balance < -1E+6)) {
            throw new \InvalidArgumentException('invalid value for $min_allowed_balance when calling Organization., must be bigger than or equal to -1E+6.');
        }
    ...
    public function setMargin($margin)
    {
        ...
        if (!is_null($margin) && ($margin < 0)) {
            throw new \InvalidArgumentException('invalid value for $margin when calling Organization., must be bigger than or equal to 0.');
        }
    ...
    public function setOwnerExchangeCommission($owner_exchange_commission)
    {
        ...
        if (!is_null($owner_exchange_commission) && ($owner_exchange_commission < 0)) {
            throw new \InvalidArgumentException('invalid value for $owner_exchange_commission when calling Organization., must be bigger than or equal to 0.');
        }
    ...
    public function setPlatform($platform)
    {
        ...
        if (!is_null($platform) && ($platform < 0)) {
            throw new \InvalidArgumentException('invalid value for $platform when calling Organization., must be bigger than or equal to 0.');
        }
