...
/**
 * NewAdvertiser Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class NewAdvertiser implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'newAdvertiser';
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['commission'] > 1)) {
            $invalidProperties[] = "invalid value for 'commission', must be smaller than or equal to 1.";
        }

        if (($this->container['commission'] < 0)) {
    ...
    public function setMinAllowedBalance($min_allowed_balance)
    {
        ...
        if (($min_allowed_balance > 0)) {
            throw new \InvalidArgumentException('invalid value for $min_allowed_balance when calling NewAdvertiser., must be smaller than or equal to 0.');
        }
        if (($min_allowed_balance < -1E+6)) {
            throw new \InvalidArgumentException('invalid value for $min_allowed_balance when calling NewAdvertiser., must be bigger than or equal to -1E+6.');
        }
    ...
    public function setMargin($margin)
    {
        ...
        if (($margin > 1)) {
            throw new \InvalidArgumentException('invalid value for $margin when calling NewAdvertiser., must be smaller than or equal to 1.');
        }
        if (($margin < 0)) {
            throw new \InvalidArgumentException('invalid value for $margin when calling NewAdvertiser., must be bigger than or equal to 0.');
        }
     ...
     * Sets commission
     *
     * @param float $commission Baked-in commission.
     *
     * @return $this
     */
    public function setCommission($commission)
    {
        ...
        if (($commission > 1)) {
            throw new \InvalidArgumentException('invalid value for $commission when calling NewAdvertiser., must be smaller than or equal to 1.');
        }
        if (($commission < 0)) {
            throw new \InvalidArgumentException('invalid value for $commission when calling NewAdvertiser., must be bigger than or equal to 0.');
        }
