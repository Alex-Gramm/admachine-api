...
class Strategy implements ModelInterface, ArrayAccess
{
    ...
    public function setStartTimeInterface($start_time_interface)
    {
        ...
        if (!is_null($start_time_interface) && (!preg_match("/^(([0,1][0-9])|(2[0-3])):[0-5][0-9]$/", $start_time_interface))) {
            throw new \InvalidArgumentException("invalid value for $start_time_interface when calling Strategy., must conform to the pattern /^(([0,1][0-9])|(2[0-3])):[0-5][0-9]$/.");
        }
    ...
    public function setEndTimeInterface($end_time_interface)
    {
        ...
        if (!is_null($end_time_interface) && (!preg_match("/^(([0,1][0-9])|(2[0-3])):[0-5][0-9]$/", $end_time_interface))) {
            throw new \InvalidArgumentException("invalid value for $end_time_interface when calling Strategy., must conform to the pattern /^(([0,1][0-9])|(2[0-3])):[0-5][0-9]$/.");
        }
    ...
    public function setTotalBudget($total_budget)
    {
        ...
        if (!is_null($total_budget) && ($total_budget > 9999999)) {
            throw new \InvalidArgumentException('invalid value for $total_budget when calling Strategy., must be smaller than or equal to 9999999.');
        }
        if (!is_null($total_budget) && ($total_budget < 1)) {
            throw new \InvalidArgumentException('invalid value for $total_budget when calling Strategy., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxBid($max_bid)
    {
        ...
        if (!is_null($max_bid) && ($max_bid > 999999.99)) {
            throw new \InvalidArgumentException('invalid value for $max_bid when calling Strategy., must be smaller than or equal to 999999.99.');
        }
        if (!is_null($max_bid) && ($max_bid < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $max_bid when calling Strategy., must be bigger than or equal to 0.01.');
        }
    ...
    public function setLocalBudget($local_budget)
    {
        ...
        if (!is_null($local_budget) && ($local_budget > 999999.99)) {
            throw new \InvalidArgumentException('invalid value for $local_budget when calling Strategy., must be smaller than or equal to 999999.99.');
        }
        if (!is_null($local_budget) && ($local_budget < 25)) {
            throw new \InvalidArgumentException('invalid value for $local_budget when calling Strategy., must be bigger than or equal to 25.');
        }
    ...
    public function setImpressionsCap($impressions_cap)
    {
        ...
        if (!is_null($impressions_cap) && ($impressions_cap < 1)) {
            throw new \InvalidArgumentException('invalid value for $impressions_cap when calling Strategy., must be bigger than or equal to 1.');
        }
    ...
    public function setMacrosCustomData($macros_custom_data)
    {
        if (!is_null($macros_custom_data) && (mb_strlen($macros_custom_data) > 500)) {
            throw new \InvalidArgumentException('invalid length for $macros_custom_data when calling Strategy., must be smaller than or equal to 500.');
        }
    ...
    public function setCustomXmlParams($custom_xml_params)
    {
        if (!is_null($custom_xml_params) && (mb_strlen($custom_xml_params) > 500)) {
            throw new \InvalidArgumentException('invalid length for $custom_xml_params when calling Strategy., must be smaller than or equal to 500.');
        }
