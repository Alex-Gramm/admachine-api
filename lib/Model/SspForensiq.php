 ...
 * @link     https://openapi-generator.tech
 */
class SspForensiq implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ssp_forensiq';
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Forensiq enabled. **Only for Root**
     *
     * @return $this
     */
     ...
     * Sets request_limit
     *
     * @param int|null $request_limit Forensiq request limit. **Only for Root**
     *
     * @return $this
     */
