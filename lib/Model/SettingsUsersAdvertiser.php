...
class SettingsUsersAdvertiser implements ModelInterface, ArrayAccess
{
    ...
    public function setDefaultMargin($default_margin)
    {
        ...
        if (!is_null($default_margin) && ($default_margin < 0)) {
            throw new \InvalidArgumentException('invalid value for $default_margin when calling SettingsUsersAdvertiser., must be bigger than or equal to 0.');
        }
    ...
    public function setDefaultCommission($default_commission)
    {
        ...
        if (!is_null($default_commission) && ($default_commission < 0)) {
            throw new \InvalidArgumentException('invalid value for $default_commission when calling SettingsUsersAdvertiser., must be bigger than or equal to 0.');
        }
