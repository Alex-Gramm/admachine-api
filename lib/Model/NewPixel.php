...
class NewPixel implements ModelInterface, ArrayAccess
{
    ...
    public function setUserTtlDays($user_ttl_days)
    {
        ...
        if (!is_null($user_ttl_days) && ($user_ttl_days < 1)) {
            throw new \InvalidArgumentException('invalid value for $user_ttl_days when calling NewPixel., must be bigger than or equal to 1.');
        }
