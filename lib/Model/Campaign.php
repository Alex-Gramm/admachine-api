...
class Campaign implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['has_strategy'] = isset($data['has_strategy']) ? $data['has_strategy'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['frequency_cap']) && ($this->container['frequency_cap'] < 0)) {
     ...
     * Sets iab_category
     *
     * @param string[]|null $iab_category IAB Category. Required. ID values of parameter `iab_categories` in /constants is added to this parameter.
     *
     * @return $this
     */
     ...
     * Sets time_zone
     *
     * @param float|null $time_zone Time Zone. Required. One of the ID values of parameter `time_zones` in /constants is added to this parameter.
     *
     * @return $this
     */
     ...
     *
     * @param float|null $is_unlimited_budget Budget Flights. 1 - Unlimited, 0 - Use Flights. Required.
     *
     * @return $this
     */
     ...
     *
     * @param float|null $daily_budget_is_unlimited Daily Spend Cap. 1 - Unlimited, 0 - Use daily_budget. Required
     *
     * @return $this
     */
    ...
    public function setDailyBudget($daily_budget)
    {
        ...
        if (!is_null($daily_budget) && ($daily_budget < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $daily_budget when calling Campaign., must be bigger than or equal to 0.01.');
        }
     ...
     * Sets frequency_cap
     *
     * @param float|null $frequency_cap Required.
     *
     * @return $this
     */
    public function setFrequencyCap($frequency_cap)
    {
        ...
        if (!is_null($frequency_cap) && ($frequency_cap < 0)) {
            throw new \InvalidArgumentException('invalid value for $frequency_cap when calling Campaign., must be bigger than or equal to 0.');
        }
    ...
    public function setMacrosCustomData($macros_custom_data)
    {
        if (!is_null($macros_custom_data) && (mb_strlen($macros_custom_data) > 500)) {
            throw new \InvalidArgumentException('invalid length for $macros_custom_data when calling Campaign., must be smaller than or equal to 500.');
        }
    ...
    public function setPixelEventsRepeatTime($pixel_events_repeat_time)
    {
        ...
        if (!is_null($pixel_events_repeat_time) && ($pixel_events_repeat_time < 1)) {
            throw new \InvalidArgumentException('invalid value for $pixel_events_repeat_time when calling Campaign., must be bigger than or equal to 1.');
        }
    ...
    public function setPostClickWindow($post_click_window)
    {
        ...
        if (!is_null($post_click_window) && ($post_click_window < 1)) {
            throw new \InvalidArgumentException('invalid value for $post_click_window when calling Campaign., must be bigger than or equal to 1.');
        }
    ...
    public function setPostViewWindow($post_view_window)
    {
        ...
        if (!is_null($post_view_window) && ($post_view_window < 1)) {
            throw new \InvalidArgumentException('invalid value for $post_view_window when calling Campaign., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['has_strategy'];
    }

    /**
     * Sets has_strategy
     *
     * @param bool|null $has_strategy Is Campaign has Strategy
     *
     * @return $this
     */
    public function setHasStrategy($has_strategy)
    {
        $this->container['has_strategy'] = $has_strategy;
     ...
     * Sets total_budget
     *
     * @param float|null $total_budget Total Budget for all Flights
     *
     * @return $this
     */
