...
class NewAgency implements ModelInterface, ArrayAccess
{
    ...
    public function setMinAllowedBalance($min_allowed_balance)
    {
        ...
        if (($min_allowed_balance < -1E+6)) {
            throw new \InvalidArgumentException('invalid value for $min_allowed_balance when calling NewAgency., must be bigger than or equal to -1E+6.');
        }
    ...
    public function setMargin($margin)
    {
        ...
        if (($margin < 0)) {
            throw new \InvalidArgumentException('invalid value for $margin when calling NewAgency., must be bigger than or equal to 0.');
        }
