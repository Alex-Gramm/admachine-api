...
class NewDsp implements ModelInterface, ArrayAccess
{
    ...
    public function setMaxResponseTime($max_response_time)
    {
        ...
        if (($max_response_time < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_response_time when calling NewDsp., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxQps($max_qps)
    {
        ...
        if (!is_null($max_qps) && ($max_qps < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_qps when calling NewDsp., must be bigger than or equal to 1.');
        }
