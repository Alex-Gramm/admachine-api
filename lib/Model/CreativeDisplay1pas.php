...
/**
 * CreativeDisplay1pas Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreativeDisplay1pas implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Creative_Display_1pas';
     ...
     *
     * @param string|null $image_attachment Image to upload. Only '.gif, .png, .jpg, .jpeg' is allowed.
     *
     * @return $this
     */
    ...
    public function setMacrosCustomData($macros_custom_data)
    {
        if (!is_null($macros_custom_data) && (mb_strlen($macros_custom_data) > 500)) {
            throw new \InvalidArgumentException('invalid length for $macros_custom_data when calling CreativeDisplay1pas., must be smaller than or equal to 500.');
        }
